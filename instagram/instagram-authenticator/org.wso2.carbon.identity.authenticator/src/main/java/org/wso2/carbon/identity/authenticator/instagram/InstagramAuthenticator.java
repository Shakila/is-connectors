...
public class InstagramAuthenticator extends OpenIDConnectAuthenticator implements FederatedApplicationAuthenticator {
    ...
    protected void processAuthenticationResponse(HttpServletRequest request,
        ...
        try {
            ...
            String accessToken = JSONUtils.parseJSON(token).get(InstagramAuthenticatorConstants.ACCESS_TOKEN).toString();
    ...
    protected Map< ClaimMapping, String > getSubjectAttributes(OAuthClientResponse token,
        ...
        try {
            ...
            String accessToken = JSONUtils.parseJSON(jsonString).get(InstagramAuthenticatorConstants.ACCESS_TOKEN).toString();
